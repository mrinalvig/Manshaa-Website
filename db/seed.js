...
const createCategories = () => {
    ...
    var earingPage = ['https://rb.gy/4qorwu', 'https://rb.gy/zzigbl', 'https://rb.gy/axza8g', 'https://rb.gy/xdgjy5', 'https://rb.gy/4xgiiy'];

    var lahengaPage = ['https://rb.gy/j6fpmg'];

    var ghararaPage = ['https://rb.gy/ntdook'];

    var ringPage = ['https://rb.gy/tsiitg', 'https://rb.gy/knxpvj', 'https://rb.gy/tsiitg', 'https://rb.gy/suomwf', 'https://rb.gy/jjyvc7', 'https://rb.gy/lyyadx', 'https://rb.gy/j86shf'];

    var banglesPage = ['https://rb.gy/bvk9vm', 'https://rb.gy/h5c9if', 'https://rb.gy/yzhtlr', 'https://rb.gy/bk6dmx', 'https://rb.gy/algyvr'];

    var chokerPage = ['https://rb.gy/kvk9o2'];
