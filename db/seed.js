...
const createCategories = () => {
    ...
    var suitPrice = [550, 475, 559, 550, 650, 550, 375, 450, 400, 475];
    ...
    for(var i = 0; i < jewelrySale.length; i++) {
        db.query(`INSERT INTO jewelry (title, description, price, category, images) VALUES ('${newBridalTitle[i]}', '${bridalDescription[i]}', ${bridalPrices[i]}, 'jewelrySale', '${jewelrySale[i]}')`, (err, result) => {
            if(err) {
                console.log(err);
            } else {
    ...
    // Bridal push
    for(var i = 0; i < 30; i++) {
        db.query(`INSERT INTO women (title, description, price, category, images) VALUES ('${newBridalTitle[i]}', '${bridalDescription[i]}', ${bridalPrices[i]}, 'bridal', '${bridalArray[i]}')`, (err, result) => {
            if(err) {
                console.log(err);
            } else {
